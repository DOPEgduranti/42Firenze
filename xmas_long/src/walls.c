...
/*   Updated: 2023/12/20 12:20:39 by gduranti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_wall_img	ft_wallgen(t_game *game)
{
	...
	wall.block = mlx_xpm_file_to_image(game->mlx, "img/wall0.xpm",
			&game->img_size.x, &game->img_size.y);
	wall.gen = mlx_xpm_file_to_image(game->mlx, "img/wall0.xpm",
			&game->img_size.x, &game->img_size.y);
	wall.corner1 = mlx_xpm_file_to_image(game->mlx, "img/wall0.xpm",
			&game->img_size.x, &game->img_size.y);
	wall.corner2 = mlx_xpm_file_to_image(game->mlx, "img/wall0.xpm",
			&game->img_size.x, &game->img_size.y);
	return (wall);
}
